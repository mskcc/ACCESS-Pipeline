...
# Todo: specify names here, not in the tool
#            fastq_1_name:
#              valueFrom: ${return inputs.input_bam.basename.replace('.bam', '_R1.fastq')}
#            fastq_2_name:
#              valueFrom: ${return inputs.input_bam.basename.replace('.bam', '_R2.fastq')}
