...
def debug_args():
    parser = argparse.ArgumentParser()
    parser.add_argument("--anno_maf", default='/Users/hasanm/Documents/projects/ACCESS/Tech-dev/TestVariantPipeline/FilterTestset/MSK-L-115_T.MSK-L-115_N.combined-variants.vep_taggedHotspots_rmv.maf')
    parser.add_argument('--fillout_maf', default='/Users/hasanm/Documents/projects/ACCESS/Tech-dev/TestVariantPipeline/FilterTestset/MSK-L-115_T.MSK-L-115_N.combined-variants.vep_taggedHotspots_rmv_fillout.maf')
    parser.add_argument("--tumor_samplename", default='MSK-L-115_T_S1_001')
    parser.add_argument("--normal_samplename", default='MSK-L-115_N_S7_001')
