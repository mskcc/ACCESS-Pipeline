...
# ='/home/hasanm/Innovation/sandbox/Maysun/FingerPrinting/testPipeline/justFPSnps.txt'
def runFPreport (OutputDir, WaltzDir, configFile, expectedFile):
    #try:
    ...
    # Todo: change fpOutputdir in this following call, in order to merge QC pdfs with FP pdfs
...
def parse_arguments():
    ...
    # Todo: This should come from the title file
