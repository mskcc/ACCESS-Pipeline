...
# make output files
echo -e "FamilySize\tFamilyType\tFrequency\tSample_ID" > family-sizes.txt
#echo -e "Clusters\tSample_ID" > families-per-position.txt
echo -e "Sample_ID\tType\tCount" > family-types-A.txt
echo -e "Sample_ID\tType\tCount" > family-types-B.txt
