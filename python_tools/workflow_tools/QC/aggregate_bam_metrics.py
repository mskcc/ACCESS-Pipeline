...
def create_waltz_coverage_file(files):
    ...
    for files in [input_files, unique_input_files]:
        ...
        coverage_df.columns = AGBM_INTERVALS_COVERAGE_SUM_ALL_INTERVALS_FILE_HEADER
...
def create_sum_of_coverage_dup_temp_file(files):
    ...
    intervals_coverage_all.columns = AGBM_INTERVALS_COVERAGE_SUM_ALL_INTERVALS_FILE_HEADER
...
def create_intervals_coverage_sum_file():
    ...
    intervals_coverage_sum.columns = AGBM_INTERVALS_COVERAGE_SUM_ALL_INTERVALS_FILE_HEADER + ['coverage_without_duplicates']
