...
# -P 				Project_10619_B \
# -T 				/juno/work/access/production/runs/Project_10619_B/metadata/Project_10619_B.txt \
# -P 				/juno/work/access/production/runs/Project_10619_B/small_variants/pairing.txt \
# -DTB 			    /juno/work/access/production/runs/Project_10619_B/bam_qc/Project_10619_B_1.3.26/duplex_tumor_bams \
# -STB 			    /juno/work/access/production/runs/Project_10619_B/bam_qc/Project_10619_B_1.3.26/simplex_tumor_bams \
# -UTB 			    /juno/work/access/production/runs/Project_10619_B/copy_number_variants/unfiltered_tumor_bams \
# -STTB 			/juno/work/access/production/runs/Project_10619_B/bam_qc/Project_10619_B_1.3.26/all_standard_bams \
# -UNB 			    /juno/work/access/production/runs/Project_10619_B/bam_qc/Project_10619_B_1.3.26/unfiltered_normal_bams \
# -DDN 			    /work/access/production/resources/msk-access/current/novaseq_unmatched_normal_plasma_duplex_bams_dmp/current/DONOR22-TP_cl_aln_srt_MD_IR_FX_BR__aln_srt_IR_FX-duplex.bam \
# -DSTN 			/work/access/production/resources/msk-access/current/novaseq_unmatched_normal_plasma_standard_bams_dmp/current/DONOR22-TP_cl_aln_srt_MD_IR_FX_BR.bam \
# -CDB 			    /work/access/production/resources/msk-access/current/novaseq_curated_duplex_bams_dmp/current/ \
# -CSB 			    /work/access/production/resources/msk-access/current/novaseq_curated_simplex_bams_dmp/current/

# Todo: hard code these options?
# /work/access/production/resources/msk-access/current/novaseq_unmatched_normal_plasma_duplex_bams_dmp/current/DONOR22-TP_cl_aln_srt_MD_IR_FX_BR__aln_srt_IR_FX-duplex.bam
# curated bam directories
# default standard normal bams
